                        ...
                        JOIN ( (SELECT   
								 ...
								 (  
									...
									AND tbC.ClassId IN
										(
										  ...
										  WHERE c.ClassId = CASE WHEN @ClassId = -1 THEN c.ClassId  ELSE @ClassId END
										  AND c.SchoolYearId = CASE WHEN @ClassId = -1 THEN @SchoolYearId  ELSE @SchoolYearId END
						 ...
						 JOIN  
                            ...
                            WHERE   
								...
								AND tempC.ClassId = CASE WHEN @ClassId = -1 THEN tempC.ClassId  ELSE @ClassId END
								AND tempC.SchoolYearId = CASE WHEN @ClassId = -1 THEN @SchoolYearId  ELSE tempC.SchoolYearId END

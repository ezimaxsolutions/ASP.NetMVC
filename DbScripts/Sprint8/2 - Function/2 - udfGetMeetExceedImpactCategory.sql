...
-- =============================================
--SELECT dbo.[udfGetMeetExceedImpactCategory] (0.2529)

--Drop function if exists in the system
IF EXISTS (SELECT * FROM sys.objects WHERE type ='FN' AND name = 'udfGetMeetExceedImpactCategory')
BEGIN
	DROP Function udfGetMeetExceedImpactCategory
END	
GO

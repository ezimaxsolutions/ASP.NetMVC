...
namespace EDS.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            if ((User.Identity.IsAuthenticated) && (Session["SiteUser"] == null))
            {
        ...
        public ActionResult ResetPassword(ResetPasswordModel model)
        {
            try
            {
                ...
                if (email != string.Empty && email != null)
                {
                    ...
                    {
                        services.EmailPasswordReset(@"tmurphy@psclistens.com", token, services.GetUserIdByUserName(model.UserName));
                    }
                    else
                    {
